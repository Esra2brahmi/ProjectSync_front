...
const UpdateSupervisorModal = ({ 
  ...
  useEffect(() => {
    if (isOpen && supervisor) {
      setFormData({
        ...
        departmentIds: supervisor.departmentIds || [],
      });
    }
  }, [isOpen, supervisor]);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await onUpdateSupervisor({
        ...formData,
        id: supervisor.id // Include the supervisor ID for the update
      });
  ...
  return (
    <Modal isOpen={isOpen} toggle={toggle}>
      <ModalHeader toggle={toggle}>Update Supervisor</ModalHeader>
