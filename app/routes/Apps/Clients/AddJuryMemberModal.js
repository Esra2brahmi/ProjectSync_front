...
const AddJuryMemberModal = ({ isOpen, toggle, onAddJuryMember }) => {
  ...
  e.preventDefault();
  try {
    await onAddJuryMember(formData);
    ...
    console.error("Failed to add jury member:", error);
  }
};

  return (
    <Modal isOpen={isOpen} toggle={toggle}>
      <ModalHeader toggle={toggle}>Add New jury Member</ModalHeader>
